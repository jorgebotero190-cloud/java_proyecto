...
public class TiposDeDatosPrimitivos {
    ...
    public static void demostrarCaracteres() {
        ...
        System.out.println("Unicode (corazón): " + unicode);
        System.out.println();
    }
    ...
    // Valores por defecto (variables estáticas)
    ...
    public static void demostrarValoresPorDefecto() {
        ...
        System.out.println("char (visual): '" + charDefault + "'");
        System.out.println("boolean: " + booleanDefault);
        System.out.println("\nNota: Los valores por defecto aplican solo a variables de instancia o estáticas.\n");
    }
}